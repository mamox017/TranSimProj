...
bool rLocalSimulator::Start(std::ostream &o) {
  ...
  // CC Eastbound stops
  Stop * stop_CC_EB_1 = new Stop(0, 44.972392, -93.243774);  // West bank stion
  Stop * stop_CC_EB_2 = new Stop(1, 44.973580, -93.235071);  // stu union stion
  Stop * stop_CC_EB_3 = new Stop(2, 44.975392, -93.226632);  // Oak St & WashAve
...
bool rLocalSimulator::Update(std::ostream &o) {
  // increase time
